...
/-! # Script to check `LeanBourbaki/Chapter1.yaml`
...
def databases : List (String × String) := [
  ("chap1.json", "Entries in `LeanBourbaki/Chapter1.yaml` refer to declarations that don't exist. Please correct the following:")
]
